...
function renderLaborTab(){
  ...
  el("tab-labor").innerHTML =
    ...
    '<section class="card">'+
      ...
      '<p class="lede">Full-time or salaried staff. Enter the month’s wage once. It is split across open (non-vacation) days on the P&amp;L every month until you change it.</p>'+
